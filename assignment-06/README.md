1. There can only be one head and one body element. The head is data that the browser processes and is not visible to visitors. The body is the content displayed to visitors.
